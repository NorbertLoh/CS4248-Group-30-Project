...
REMOTE_FILE="~/$REMOTE_BASE_DIR/datapreparation/output/results/preds_Qwen3-VL-8B-Instruct-unsloth-bnb-4bit.jsonl"
LOCAL_DIR="~/$REMOTE_BASE_DIR/datapreparation/output/results"
...
echo "Done. Downloaded preds_Qwen3-VL-8B-Instruct-unsloth-bnb-4bit.jsonl"