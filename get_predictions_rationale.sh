...
# Script to fetch outputs produced by cara/sft/rationale-vllm.py
# Usage: ./get_predictions_rationale.sh
...
REMOTE_OUTPUT_FILE="${REMOTE_OUTPUT_FILE:-predictions_rationale_vllm_8B.jsonl}"
