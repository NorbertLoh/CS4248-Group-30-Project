...
BASELINE_DATA_PATH="${BASELINE_DATA_PATH:-datapreparation/output/facebook-samples-test.jsonl}"
BASELINE_OUT_PATH="${BASELINE_OUT_PATH:-datapreparation/output/predictions_baseline_vllm_32b.jsonl}"
BASELINE_MODEL_ID="${BASELINE_MODEL_ID:-QuantTrio/Qwen3-VL-32B-Thinking-AWQ}"
